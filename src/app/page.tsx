...
export default function Home() {
  return (
    <main className="photobooth-main relative flex min-h-[100dvh] w-full flex-col items-center justify-start gap-4 overflow-hidden bg-transparent px-4 py-4 text-white sm:gap-6 sm:px-6 sm:py-6 md:justify-center md:gap-10 md:py-5">
